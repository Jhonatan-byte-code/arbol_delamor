...
function showDedicationText() { //seguidores
  ...
  if (!text) {
    text = `Para el amor de mi vida (mamá de Iris):\n\nDesde el primer momento supe que eras tú. Tu sonrisa, tu voz, tu mirada, tu forma de ser, en si todo de ti…\n\nQuiero que sepas que te amo, que sin importar dónde y como estemos, te quiero con todo mi ser, eres mi lugar más lindo donde puedo ser yo\n\nEres una personita tan maravillosa, con un gran corazón, no sabes lo afortunado que me siento de tenerte en mi vida, quiero que esto dure por mucho tiempo\n\nQuiero permanecer en tu vida y que tú permanezcas en la mía, me haces muy feliz...sin duda que más puedo pedir a la vida, si tenerte a ti es tenerlo todo.`;  } else {
...
function showSignature() {
  ...
  signature.textContent = firma ? decodeURIComponent(firma) : "Con amor, Jhonatan";
...
function showCountdown() {
  ...
  let startDate = startParam ? new Date(startParam + 'T00:00:00') : new Date('2025-08-09T00:00:00'); 
  let eventDate = eventParam ? new Date(eventParam + 'T00:00:00') : new Date('2025-09-09T00:00:00');
